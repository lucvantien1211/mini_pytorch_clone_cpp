...
TEST(TensorTest, TensorScalarAdditionDoesNotModifyInputs) {
    mt::Tensor a({2, 3});
    float b = 10.0f;
...
TEST(TensorTest, TensorScalarSubtractionDoesNotModifyInputs) {
    mt::Tensor a({2, 3});
    float b = 10.0f;
...
TEST(TensorTest, TensorScalarProductionDoesNotModifyInputs) {
    mt::Tensor a({2, 3});
    float b = 10.0f;
...
TEST(TensorTest, TensorScalarDivisionThrowOnZeroDivisor) {
    mt::Tensor a({2, 3});
    float b = 10.0f;
    float c = 0.0;
